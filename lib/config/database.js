  ...
  if (exports.db === null) {
    exports.db = new sqlite3.Database(config.databaseFile, function(err) {
      ...
      exports.db.serialize(function() {
        ...
        exports.db.run("CREATE TABLE proposals (id INTEGER PRIMARY KEY, userid INT, name TEXT, description TEXT)");
        exports.db.run("INSERT INTO proposals (userid, name, description) VALUES(1, 'Prop123', 'Description for Prop123')");
        exports.db.run("INSERT INTO proposals (userid, name, description) VALUES(1, 'TestProp', 'Description for TestProp')");
